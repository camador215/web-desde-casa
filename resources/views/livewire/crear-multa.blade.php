                ...
                <form>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="importe" wire:model="importe">
                        </div> 
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="boleta_prestamo_id" class="block text-gray-700 text-sm font-bold mb-2">Boleta:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="boleta_prestamo_id" wire:model="boleta_prestamo_id">
                        </div>  
